...
class Carro:
    ...
    def listar(self):
        return f'Nome do carro: {self.nome}\n' \
               f'Nome do motor: {self.motor.nome}\n' \
               f'Nome do fabricante: {self.fabricante.nome}'
...
fabricante_Renault = Fabricante('Renaut')
motor_Volkswagen = Motor('Volkswagen')
motor_fiat = Motor('Bagulho')

carro2 = Carro('Ferrari')
carro2.motor = motor_Volkswagen
carro2.fabricante = fabricante_Renault
carro2.motor = motor_fiat 
